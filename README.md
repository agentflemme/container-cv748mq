...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-cv748mq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-cv748mq.containers.anotherwebservice.com/
...
```
git clone git@github.com:agentflemme/container-cv748mq.git
cd container-cv748mq
```
...
```
docker attach container-cv748mq
```
